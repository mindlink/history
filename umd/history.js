...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.__esModule = true;
	exports.locationsAreEqual = exports.safeDecodeURI = exports.createLocation = undefined;
	...
	var createLocation = exports.createLocation = function createLocation(path, state, key, currentLocation, useRawPathname) {
	  var location = void 0;
	...
	var safeDecodeURI = exports.safeDecodeURI = function safeDecodeURI(path) {
	  try {
	...
	var locationsAreEqual = exports.locationsAreEqual = function locationsAreEqual(a, b) {
	  return safeDecodeURI(a.pathname) === safeDecodeURI(b.pathname) && a.search === b.search && a.hash === b.hash && a.key === b.key && (0, _valueEqual2.default)(a.state, b.state);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addTrailingSlashIfRequired = function addTrailingSlashIfRequired(path) {
	...
	var HashPathCoders = {
	  hashbang: {
	    encodePath: function encodePath(path) {
	      return addTrailingSlashIfRequired(path.charAt(0) === '!' ? path : '!/' + (0, _PathUtils.stripLeadingSlash)(path));
	    },
	    decodePath: function decodePath(path) {
	      return addTrailingSlashIfRequired(path.charAt(0) === '!' ? path.substr(1) : path);
	    }
	  },
	  noslash: {
	    encodePath: function encodePath(path) {
	      return addTrailingSlashIfRequired((0, _PathUtils.stripLeadingSlash)(path));
	    },
	    decodePath: function decodePath(path) {
	...
	var createHashHistory = function createHashHistory() {
	  ...
	  var push = function push(path, state) {
	    ...
	    var action = 'PUSH';
	    var location = (0, _LocationUtils.createLocation)(path, undefined, undefined, history.location, true);
